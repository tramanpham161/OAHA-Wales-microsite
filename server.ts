...
import { WHITEPAPER_PAGES } from "./src/lib/whitepaper-data.js";
...
app.post(["/api/gemini/analyze-pitch", "/gemini/analyze-pitch"], async (req, res) => {
  try {
...
app.post(["/api/gemini/content-assistant", "/gemini/content-assistant"], async (req, res) => {
  try {
